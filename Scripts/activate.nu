...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\Project_cerebulb\DS_Airfilter-development\RUL_Prediction_Latest\Train_deplo_DL_model_using_gcp\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\Project_cerebulb\DS_Airfilter-development\RUL_Prediction_Latest\Train_deplo_DL_model_using_gcp\venv\Scripts\deactivate.nu'
